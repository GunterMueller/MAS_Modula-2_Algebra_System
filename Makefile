...
# The cpp flags
CPPFLAGS= -I/usr/local/lib/mtc//lib/include -DDEFAULT_MASINPUTS="\"$(masinputdir)\"" -I$(top_srcdir) -I$(top_srcdir)/lib -I.
...
# Flags for mtc
MTCFLAGS =  -d/usr/local/lib/mtc//lib/reuse $(addprefix -d$(top_srcdir)/,$(DIRS)) -d. -d.
