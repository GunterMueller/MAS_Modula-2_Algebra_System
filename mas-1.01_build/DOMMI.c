...
MASADOM_Domain DOMMI_DOMMID;
CHAR DOMMI_rcsid [] = "$Id: DOMMI.md,v 1.2 1992/02/12 17:31:31 pesch Exp $";
CHAR DOMMI_copyright [] = "Copyright (c) 1989 - 1992 Universitaet Passau";

static CHAR rcsidi [] = "$Id: DOMMI.mi,v 1.5 1994/09/06 11:49:03 rose Exp $";
...
# endif
{
  ...
  d = MASADOM_NewDom("MI", 2L, "Modular Integer", 15L);
  DOMMI_DOMMID = d;
