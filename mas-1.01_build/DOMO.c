...
CHAR DOMO_rcsid [] = "$Id: DOMO.md,v 1.1 1992/09/28 17:47:06 kredel Exp $";
CHAR DOMO_copyright [] = "Copyright (c) 1989 - 1992 Universitaet Passau";
MASADOM_Domain DOMO_DOMOD;

static CHAR rcsidi [] = "$Id: DOMO.mi,v 1.5 1994/09/06 11:49:06 rose Exp $";
...
# endif
{
  ...
  d = MASADOM_NewDom("O", 1L, "Octonion Number", 15L);
  DOMO_DOMOD = d;
