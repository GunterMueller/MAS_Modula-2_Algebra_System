...
CONST rcsidi = "$Id: DOMMI.mi,v 1.5 1994/09/06 11:49:03 rose Exp $";
...
VAR   d: Domain;
BEGIN
(*1*) d:=NewDom("MI","Modular Integer"); DOMMID:=d;
(*2*) SetDifFunc(d,DDIF); 
      SetExpFunc(d,DEXP); 
      SetFIntFunc(d,DFI); 
      SetFIPolFunc(d,DFIP); 
